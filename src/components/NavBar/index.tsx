    ...
    <>
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          />
          <button
            className='fixed top-0 left-1/2 -translate-x-1/2 w-60 h-10 bg-violet-600 text-white font-bold text-3xl rounded-b-xl  shadow-especial shadow-violet-950 hover:shadow-zinc-800 z-20'
            onClick={HadleAddAnimation}
          >
            MENU
          </button>
