...
const PackagePlan = ({ register }: any) => {
  ...
  const createPlan = ({
    ...
    <div className='rounded w-full h-auto bg-zinc-300 flex gap-3 p-2'>
      <label
  ...
  return (
    <div className='flex items-start justify-center gap-2 w-full p-5'>
      {createPlan({
        Title: 'Plano 1',
