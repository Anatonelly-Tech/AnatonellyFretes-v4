    ...
    <div className="w-full h-full flex flex-col ">
      <div className="flex w-full h-full justify-between ">
        <div className="flex-1">
          <h1 className="bg-gradient-to-br from-purple-600 to-violet-700 absolute w-auto text-start  inline-block text-transparent bg-clip-text text-6xl font-extrabold break-all">
            Lista de
            <br /> Fretes
          </h1>
        </div>
